...
@section('title', 'Forgot Password - Doc Pro | Secure Account Recovery')
@section('meta_description', 'Reset your password on Doc Pro. Enter your email, and we will send you a reset link to regain access to your account.')
@section('meta_keywords', 'forgot password, reset password, account recovery, free document generator, secure login, Doc Pro')
...
<script type="application/ld+json">
{
    ...
    "@type": "WebPage",
    "name": "Forgot Password - Doc Pro",
    "description": "Reset your password on Doc Pro. Enter your email, and we will send a reset link to regain access.",
    "url": "{{ url()->current() }}",
    "publisher": {
        "@type": "Organization",
        "name": "Doc Pro",
...
<script>
    ...
    // Ensure AdSense loads after the page is fully loaded
